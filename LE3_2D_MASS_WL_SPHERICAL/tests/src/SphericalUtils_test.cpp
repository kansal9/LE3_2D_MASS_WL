...
static Elements::Logging logger = Elements::Logging::getLogger("SphericalUtils_test");
...
//BOOST_AUTO_TEST_SUITE (SphericalUtils_test)
...
BOOST_AUTO_TEST_CASE( readSphericalParameterFile_test ) {
 std::cout << "-- SphericalUtils: readSphericalParameterFile_Test"<<std::endl;
 try {
   std::string testParamFile = Elements::getAuxiliaryPath("LE3_2D_MASS_WL_UTILITIES/Sparam_test.xml").generic_string();
   ...
   readSphericalParameterFile(testParamFile, params);
