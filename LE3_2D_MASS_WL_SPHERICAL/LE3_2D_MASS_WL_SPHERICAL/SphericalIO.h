...
public:
    ...
    /**
     * @brief     This function writes xml output file
     ...
     * @param     <GalCountJson>, <boost::filesystem::path> name of the output Density Map corresponding
     *             to Convergence Map in json file
     ...
     */
    bool writeSphericalXMLfile(boost::filesystem::path& workdir,
     ...
     * @brief     This function writes xml output file
     * @param     <workdir>, <boost::filesystem::path> work directory
     * @param     <outConvergenceMapJson>, <boost::filesystem::path> name of the output MC convergence Maps in json file
     * @param     <outXMLConvergenceMap>, <boost::filesystem::path> name of the output XML file
     * @return    <bool> true if convergence map well created
     */
    bool writeSphericalMCXMLfile(boost::filesystem::path& workdir,
            boost::filesystem::path& outConvergenceMapJson,
            boost::filesystem::path& outXMLConvergenceMap);
