/**
 * @file LE3_2D_MASS_WL_SPHERICAL/Sph_mass_mapping.h
 * @date 05/13/19
 * @author user
 *
...
public:
   ...
   * @brief Destructor
   */
  virtual ~Sph_mass_mapping() = default;
 ...
 */
  void computeReducedShear_hp(std::pair<Healpix_Map<double>, Healpix_Map<double> >& shearMap,
