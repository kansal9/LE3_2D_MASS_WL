...
public:
     ...
     * @brief Constructor
     */
    GetSphericalMCMaps(const CatalogData& inputData);

    /**
     * @brief Constructor
     */
    GetSphericalMCMaps(const CatalogData& inputData, SphericalParam &SphParam);
