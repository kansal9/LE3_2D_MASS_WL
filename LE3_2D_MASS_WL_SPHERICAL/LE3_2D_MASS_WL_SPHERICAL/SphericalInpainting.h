...
public:
 ...
 /**
  ...
  SphericalInpainting(std::pair<Healpix_Map<double>, Healpix_Map<double> >& shear, std::pair<Healpix_Map<double>,
                    Healpix_Map<double> >& convergence, LE3_2D_MASS_WL_SPHERICAL::SphericalParam &SphericalParam);
   ...
   */
  std::pair<Healpix_Map<double>, Healpix_Map<double> > maskInversion(Healpix_Map<double>& kE, Healpix_Map<double>& kB);
