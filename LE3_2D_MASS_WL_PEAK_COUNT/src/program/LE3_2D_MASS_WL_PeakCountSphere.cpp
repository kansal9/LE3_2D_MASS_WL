...
static Elements::Logging logger = Elements::Logging::getLogger("LE3_2D_MASS_WL_PeakCountSphere");

class LE3_2D_MASS_WL_PeakCountSphere : public Elements::Program {
...
public:
  ...
  // input parameter file
   ...
   // input
   options.add_options()
   ("inputConvMap", po::value<string>()->default_value(""), "input Convergence Map in Healpix format");
   // output file for Peak Catalog
   options.add_options()
   ("outputPeakCatalog", po::value<string>()->default_value(""), "Output Peak Count Catalog in fits");
   options.add_options()
   ("outputPeakCatalogXML", po::value<string>()->default_value("outputPConvCatalogXML.xml"), "Output Peak Count Catalog in XML");
    return options;
  }
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   fs::path outputPeakCatalog {args["outputPeakCatalog"].as<std::string>()};
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   if ((outputPeakCatalog.string()).empty() == true) {
     outputPeakCatalog = fs::path ("EUC_LE3_WL_PeakCatalog_Sphere_" + getDateTimeString() + ".fits");
   }
////////////////////////////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   peakCounter.savePeakCatalog_hp((workdir /outputPeakCatalog).native());
////////////////////////////////////////////////////////////////////////////////////////////////////////
 // Generate the output XML product
////////////////////////////////////////////////////////////////////////////////////////////////////////
   auto out_xml_peak_catalog =args["outputPeakCatalogXML"].as<std::string>();
    // Create a DMOutput object
    DmOutput dm;
    std::string catfile = (workdir / fs::path(out_xml_peak_catalog)).string();
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   std::chrono::duration<double> Peak_elapsed_seconds = Peak_end-start_PeakTime;
...
MAIN_FOR(LE3_2D_MASS_WL_PeakCountSphere)
