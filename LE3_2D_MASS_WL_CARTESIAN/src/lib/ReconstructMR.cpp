...
ReconstructMR::ReconstructMR(const ReconstructMR& copy) :
        C1(copy.C1), C2(copy.C2), TabHsGauss(copy.TabHsGauss),
        TabHnGauss(copy.TabHnGauss), Np(copy.Np), Step(copy.Step)
{
}
